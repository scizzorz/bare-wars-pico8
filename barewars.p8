...
function hire_unit(unit_type)
  ...
  local new = _unit(cur_player, player.castle_x * 8, player.castle_y * 8 + 16, races[player.race])
...
function make_build_menu()
  local player = players[cur_player]
  menu:clear()
  menu:add("workery", function() end, player.materials > dc[d.workery] and false)
  menu:add("barracks", function() end, player.materials > dc[d.barracks] and false)
...
function make_hire_menu()
  ...
  menu:add("warrior", function() end, player.money > uc[u.warrior] and false)
  menu.back = make_base_menu
end
...
__gfx__

...

...
__gff__

